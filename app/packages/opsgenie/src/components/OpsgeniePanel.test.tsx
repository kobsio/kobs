...
import OpsgeniePanel from './OpsgeniePanel';

describe('OpsgeniePanel', () => {
          ...
          <APIContext.Provider value={{ client: client, getUser: () => undefined }}>
            <OpsgeniePanel
              ...
              instance={{
                ...
                name: 'opsgenie',
                options: {
                  address: 'https://mycompany.app.eu.opsgenie.com',
                },
                type: 'opsgenie',
              }}
              options={options}
  ...
  it('should render error on missing options', async () => {
    render(undefined);
    expect(await waitFor(() => screen.getByText('Invalid options for Opsgenie plugin'))).toBeInTheDocument();
  });

  it('should render alerts', async () => {
    render({ queries: ['status: open', 'status: closed'], type: 'alerts' });
  ...
  it('should render incidents', async () => {
    render({ queries: ['status: open', 'status: closed'], type: 'incidents' });
