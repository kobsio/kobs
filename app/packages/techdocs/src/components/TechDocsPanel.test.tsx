...
import TechDocsPanel from './TechDocsPanel';
...
describe('TechDocsPanel', () => {
  ...
  it('should render error on missing options', async () => {
    render(undefined);
    expect(await waitFor(() => screen.getByText('Invalid options for TechDocs plugin'))).toBeInTheDocument();
  });

  it('should render services', async () => {
    render({ type: 'services' });
  ...
  it('should render service toc', async () => {
    render({ service: 'kobs', type: 'service-toc' });

    expect(await waitFor(() => screen.getByText('Test'))).toBeInTheDocument();
    expect(await waitFor(() => screen.getByText('Installation'))).toBeInTheDocument();
  });

  it('should render service markdown', async () => {
    render({ service: 'kobs', type: 'service-markdown' });
  ...
  it('should render markdown', async () => {
    ...
    expect(await waitFor(() => screen.getByText('Embed Panel'))).toBeInTheDocument();
    expect(await waitFor(() => screen.getByText('My embedded panel'))).toBeInTheDocument();

    expect(await waitFor(() => screen.getByText('Embed Dashboard'))).toBeInTheDocument();
    expect(await waitFor(() => screen.getByText('My embedded dashboard panel'))).toBeInTheDocument();
