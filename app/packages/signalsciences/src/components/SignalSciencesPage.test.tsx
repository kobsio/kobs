...
import SignalSciencesPage from './SignalSciencesPage';
...
describe('SignalSciencesPage', () => {
  ...
  it('should render overview page', async () => {
    ...
    expect(screen.getByText('signalsciences')).toBeInTheDocument();
    expect(screen.getByText('(hub / signalsciences)')).toBeInTheDocument();
  ...
  it('should render agents page with info that a site must be selected', async () => {
    render('/agents');
    ...
    expect(await waitFor(() => screen.getByText('Select a site'))).toBeInTheDocument();
  });

  it('should render agents page', async () => {
    render('/agents?site=mysitename');
  ...
  it('should render requests page with info that a site must be selected', async () => {
    render('/requests');
  ...
  it('should render requests page', async () => {
    render('/requests?site=mysitename');
