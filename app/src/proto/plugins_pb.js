...
goog.exportSymbol('proto.plugins.Template', null, global);
/**
 ...
 * @constructor
 */
proto.plugins.Template = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.plugins.Template, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.plugins.Template.displayName = 'proto.plugins.Template';
}
...
proto.plugins.Plugin.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    template: (f = msg.getTemplate()) && proto.plugins.Template.toObject(includeInstance, f),
...
proto.plugins.Plugin.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.plugins.Template;
      reader.readMessage(value,proto.plugins.Template.deserializeBinaryFromReader);
...
proto.plugins.Plugin.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.plugins.Template.serializeBinaryToWriter
    );
  }
 ...
 * @return {?proto.plugins.Template}
 */
proto.plugins.Plugin.prototype.getTemplate = function() {
  return /** @type{?proto.plugins.Template} */ (
    jspb.Message.getWrapperField(this, proto.plugins.Template, 3));
};


/**
 * @param {?proto.plugins.Template|undefined} value
 * @return {!proto.plugins.Plugin} returns this
*/
proto.plugins.Plugin.prototype.setTemplate = function(value) {
 ...
 * @return {!proto.plugins.Plugin} returns this
 */
proto.plugins.Plugin.prototype.clearTemplate = function() {
 ...
 * @return {boolean}
 */
proto.plugins.Plugin.prototype.hasTemplate = function() {
  return jspb.Message.getField(this, 3) != null;
};


/**
 * optional prometheus.Spec prometheus = 4;
...
proto.plugins.Plugin.prototype.getPrometheus = function() {
  return /** @type{?proto.plugins.prometheus.Spec} */ (
    jspb.Message.getWrapperField(this, prometheus_pb.Spec, 4));
};
...
/**
 * optional elasticsearch.Spec elasticsearch = 5;
...
proto.plugins.Plugin.prototype.getElasticsearch = function() {
  return /** @type{?proto.plugins.elasticsearch.Spec} */ (
    jspb.Message.getWrapperField(this, elasticsearch_pb.Spec, 5));
};
...
/**
 * optional opsgenie.Spec opsgenie = 7;
...
proto.plugins.Plugin.prototype.getOpsgenie = function() {
  return /** @type{?proto.plugins.opsgenie.Spec} */ (
    jspb.Message.getWrapperField(this, opsgenie_pb.Spec, 7));
};
 ...
 * @return {!Object}
 */
proto.plugins.Template.prototype.toObject = function(opt_includeInstance) {
  return proto.plugins.Template.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.plugins.Template} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.plugins.Template.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * @return {!proto.plugins.Template}
 */
proto.plugins.Template.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.plugins.Template;
  return proto.plugins.Template.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.plugins.Template} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.plugins.Template}
 */
proto.plugins.Template.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.plugins.Template.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.plugins.Template.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.plugins.Template} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.plugins.Template.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.plugins.Template.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.plugins.Template} returns this
 */
proto.plugins.Template.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 */
proto.plugins.Template.prototype.getVariablesMap = function(opt_noLazyCreate) {
 ...
 * @return {!proto.plugins.Template} returns this
 */
proto.plugins.Template.prototype.clearVariablesMap = function() {
