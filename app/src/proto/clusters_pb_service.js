...
Clusters.GetLogs = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: clusters_pb.GetLogsRequest,
  responseType: clusters_pb.GetLogsResponse
};
...
Clusters.GetTeams = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: clusters_pb.GetTeamsRequest,
  responseType: clusters_pb.GetTeamsResponse
};
...
Clusters.GetTeam = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: clusters_pb.GetTeamRequest,
...
ClustersClient.prototype.getLogs = function getLogs(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Clusters.GetLogs, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
ClustersClient.prototype.getTeams = function getTeams(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Clusters.GetTeams, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
ClustersClient.prototype.getTeam = function getTeam(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
