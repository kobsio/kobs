...
const Job: React.FunctionComponent<IJobProps> = ({ satellite, cluster, namespace, job }: IJobProps) => {
  return (
    <React.Fragment>
      ...
      {job.spec?.selector && (
        <Selector satellite={satellite} cluster={cluster} namespace={namespace} selector={job.spec.selector} />
      )}
