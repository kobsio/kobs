...
require (
	...
	github.com/kiali/kiali v1.85.0
...
require (
	...
	github.com/openshift/api v0.0.0-20240109042830-44756aa36879 // indirect
	github.com/openshift/client-go v0.0.0-20240109161853-2425b4b6d3b3 // indirect
