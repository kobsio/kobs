...
func TestGetTeams(t *testing.T) {
	for _, tt := range []struct {
		...
		},
		{
			...
			expectedBody:       "[{\"group\":\"team1\",\"permissions\":{},\"notifications\":{\"groups\":null}},{\"group\":\"team2\",\"permissions\":{},\"notifications\":{\"groups\":null}},{\"group\":\"team3\",\"permissions\":{},\"notifications\":{\"groups\":null}}]\n",
			prepare: func(t *testing.T, mockStoreClient *store.MockClient) {
		...
		},
		{
			...
			url:                "/teams",
			expectedStatusCode: http.StatusOK,
			expectedBody:       "[{\"group\":\"team1\",\"permissions\":{},\"notifications\":{\"groups\":null}}]\n",
			prepare: func(t *testing.T, mockStoreClient *store.MockClient) {
				mockStoreClient.AssertNotCalled(t, "GetTeams", mock.Anything)
