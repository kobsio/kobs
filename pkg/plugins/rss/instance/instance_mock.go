...
func (m *MockInstance) GetFeed(url string) (*gofeed.Feed, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetFeed", url)
...
func (mr *MockInstanceMockRecorder) GetFeed(url interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetFeed", reflect.TypeOf((*MockInstance)(nil).GetFeed), url)
}
