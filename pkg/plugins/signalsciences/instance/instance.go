...
type Instance interface {
	...
	GetRequests(siteName string, query url.Values) (int, string, []sigsci.Request, error)
}
...
func (i *instance) GetRequests(siteName string, query url.Values) (int, string, []sigsci.Request, error) {
