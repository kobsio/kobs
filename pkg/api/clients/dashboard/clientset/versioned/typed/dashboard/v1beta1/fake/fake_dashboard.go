...
var dashboardsResource = schema.GroupVersionResource{Group: "kobs.io", Version: "v1beta1", Resource: "dashboards"}

var dashboardsKind = schema.GroupVersionKind{Group: "kobs.io", Version: "v1beta1", Kind: "Dashboard"}
...
func (c *FakeDashboards) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Dashboard, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(dashboardsResource, c.ns, name), &v1beta1.Dashboard{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.Dashboard), err
}
...
func (c *FakeDashboards) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.DashboardList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(dashboardsResource, dashboardsKind, c.ns, opts), &v1beta1.DashboardList{})
	...
	list := &v1beta1.DashboardList{ListMeta: obj.(*v1beta1.DashboardList).ListMeta}
	for _, item := range obj.(*v1beta1.DashboardList).Items {
...
func (c *FakeDashboards) Create(ctx context.Context, dashboard *v1beta1.Dashboard, opts v1.CreateOptions) (result *v1beta1.Dashboard, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(dashboardsResource, c.ns, dashboard), &v1beta1.Dashboard{})
...
func (c *FakeDashboards) Update(ctx context.Context, dashboard *v1beta1.Dashboard, opts v1.UpdateOptions) (result *v1beta1.Dashboard, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(dashboardsResource, c.ns, dashboard), &v1beta1.Dashboard{})
...
func (c *FakeDashboards) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(dashboardsResource, c.ns, name), &v1beta1.Dashboard{})
...
func (c *FakeDashboards) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta1.DashboardList{})
	return err
}
...
func (c *FakeDashboards) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Dashboard, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(dashboardsResource, c.ns, name, pt, data, subresources...), &v1beta1.Dashboard{})
