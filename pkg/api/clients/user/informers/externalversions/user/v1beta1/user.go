...
import (
	...
	versioned "github.com/kobsio/kobs/pkg/api/clients/user/clientset/versioned"
	internalinterfaces "github.com/kobsio/kobs/pkg/api/clients/user/informers/externalversions/internalinterfaces"
	v1beta1 "github.com/kobsio/kobs/pkg/api/clients/user/listers/user/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KobsV1beta1().Users(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KobsV1beta1().Users(namespace).Watch(context.TODO(), options)
			},
		},
		&userv1beta1.User{},
		resyncPeriod,
...
func (f *userInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&userv1beta1.User{}, f.defaultInformer)
}

func (f *userInformer) Lister() v1beta1.UserLister {
	return v1beta1.NewUserLister(f.Informer().GetIndexer())
}
