...
import (
	...
	v1 "github.com/kobsio/kobs/pkg/api/apis/application/v1"
	scheme "github.com/kobsio/kobs/pkg/api/clients/application/clientset/versioned/scheme"
...
func newApplications(c *KobsV1Client, namespace string) *applications {
	return &applications{
		client: c.RESTClient(),
		ns:     namespace,
	}
