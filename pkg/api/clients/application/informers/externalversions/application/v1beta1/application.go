...
import (
	...
	applicationv1beta1 "github.com/kobsio/kobs/pkg/api/apis/application/v1beta1"
	versioned "github.com/kobsio/kobs/pkg/api/clients/application/clientset/versioned"
	internalinterfaces "github.com/kobsio/kobs/pkg/api/clients/application/informers/externalversions/internalinterfaces"
	v1beta1 "github.com/kobsio/kobs/pkg/api/clients/application/listers/application/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KobsV1beta1().Applications(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KobsV1beta1().Applications(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *applicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&applicationv1beta1.Application{}, f.defaultInformer)
}
