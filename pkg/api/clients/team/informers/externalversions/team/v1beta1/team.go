...
import (
	...
	v1beta1 "github.com/kobsio/kobs/pkg/api/clients/team/listers/team/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KobsV1beta1().Teams(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KobsV1beta1().Teams(namespace).Watch(context.TODO(), options)
			},
		},
		&teamv1beta1.Team{},
		resyncPeriod,
...
func (f *teamInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&teamv1beta1.Team{}, f.defaultInformer)
}

func (f *teamInformer) Lister() v1beta1.TeamLister {
	return v1beta1.NewTeamLister(f.Informer().GetIndexer())
}
