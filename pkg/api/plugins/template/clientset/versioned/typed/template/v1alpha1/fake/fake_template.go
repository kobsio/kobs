...
var templatesResource = schema.GroupVersionResource{Group: "kobs.io", Version: "v1alpha1", Resource: "templates"}

var templatesKind = schema.GroupVersionKind{Group: "kobs.io", Version: "v1alpha1", Kind: "Template"}
