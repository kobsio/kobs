...
import (
	...
	teamv1alpha1 "github.com/kobsio/kobs/pkg/api/plugins/team/apis/team/v1alpha1"
	versioned "github.com/kobsio/kobs/pkg/api/plugins/team/clientset/versioned"
	internalinterfaces "github.com/kobsio/kobs/pkg/api/plugins/team/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/kobsio/kobs/pkg/api/plugins/team/listers/team/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KobsV1alpha1().Teams(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KobsV1alpha1().Teams(namespace).Watch(context.TODO(), options)
			},
		},
		&teamv1alpha1.Team{},
		resyncPeriod,
...
func (f *teamInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&teamv1alpha1.Team{}, f.defaultInformer)
}
