...
import (
	...
	_ "github.com/kobsio/kobs/pkg/api/plugins/team/proto"
	_ "github.com/kobsio/kobs/pkg/api/plugins/template/proto"
	math "math"
)
...
func (in *GetTeamsRequest) DeepCopyInto(out *GetTeamsRequest) {
	p := proto.Clone(in).(*GetTeamsRequest)
	*out = *p
}
...
func (in *GetTeamsResponse) DeepCopyInto(out *GetTeamsResponse) {
	p := proto.Clone(in).(*GetTeamsResponse)
	*out = *p
}
...
func (in *GetTeamRequest) DeepCopyInto(out *GetTeamRequest) {
	p := proto.Clone(in).(*GetTeamRequest)
	*out = *p
}
...
func (in *GetTeamResponse) DeepCopyInto(out *GetTeamResponse) {
	p := proto.Clone(in).(*GetTeamResponse)
	*out = *p
}
...
// DeepCopyInto supports using GetTemplatesRequest within kubernetes types, where deepcopy-gen is used.
func (in *GetTemplatesRequest) DeepCopyInto(out *GetTemplatesRequest) {
	p := proto.Clone(in).(*GetTemplatesRequest)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GetTemplatesRequest. Required by controller-gen.
func (in *GetTemplatesRequest) DeepCopy() *GetTemplatesRequest {
	if in == nil {
		return nil
	}
	out := new(GetTemplatesRequest)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new GetTemplatesRequest. Required by controller-gen.
func (in *GetTemplatesRequest) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using GetTemplatesResponse within kubernetes types, where deepcopy-gen is used.
func (in *GetTemplatesResponse) DeepCopyInto(out *GetTemplatesResponse) {
	p := proto.Clone(in).(*GetTemplatesResponse)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GetTemplatesResponse. Required by controller-gen.
func (in *GetTemplatesResponse) DeepCopy() *GetTemplatesResponse {
	if in == nil {
		return nil
	}
...
// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new GetTemplatesResponse. Required by controller-gen.
func (in *GetTemplatesResponse) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
