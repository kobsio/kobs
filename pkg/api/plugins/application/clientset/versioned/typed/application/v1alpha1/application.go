...
import (
	...
	scheme "github.com/kobsio/kobs/pkg/api/plugins/application/clientset/versioned/scheme"
...
func newApplications(c *KobsV1alpha1Client, namespace string) *applications {
	return &applications{
		client: c.RESTClient(),
		ns:     namespace,
	}
