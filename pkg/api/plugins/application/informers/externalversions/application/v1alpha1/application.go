...
import (
	...
	applicationv1alpha1 "github.com/kobsio/kobs/pkg/api/plugins/application/apis/application/v1alpha1"
	versioned "github.com/kobsio/kobs/pkg/api/plugins/application/clientset/versioned"
	internalinterfaces "github.com/kobsio/kobs/pkg/api/plugins/application/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/kobsio/kobs/pkg/api/plugins/application/listers/application/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KobsV1alpha1().Applications(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KobsV1alpha1().Applications(namespace).Watch(context.TODO(), options)
			},
		},
