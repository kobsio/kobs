...
func getNewClusterTestError(name, server string, restConfig *rest.Config) (cluster.Client, error) {
	return nil, fmt.Errorf("could not create cluster")
}

func getNewClusterTestSuccess(name, server string, restConfig *rest.Config) (cluster.Client, error) {
