...
import (
	...
	versioned "github.com/kobsio/kobs/pkg/cluster/kubernetes/clients/dashboard/clientset/versioned"
	internalinterfaces "github.com/kobsio/kobs/pkg/cluster/kubernetes/clients/dashboard/informers/externalversions/internalinterfaces"
	v1 "github.com/kobsio/kobs/pkg/cluster/kubernetes/clients/dashboard/listers/dashboard/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KobsV1().Dashboards(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KobsV1().Dashboards(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *dashboardInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dashboardv1.Dashboard{}, f.defaultInformer)
}

func (f *dashboardInformer) Lister() v1.DashboardLister {
	return v1.NewDashboardLister(f.Informer().GetIndexer())
}
