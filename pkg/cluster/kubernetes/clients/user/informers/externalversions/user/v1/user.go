...
import (
	...
	versioned "github.com/kobsio/kobs/pkg/cluster/kubernetes/clients/user/clientset/versioned"
	...
	v1 "github.com/kobsio/kobs/pkg/cluster/kubernetes/clients/user/listers/user/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KobsV1().Users(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KobsV1().Users(namespace).Watch(context.TODO(), options)
			},
		},
		&userv1.User{},
		resyncPeriod,
