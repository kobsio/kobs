...
import (
	...
	v1 "github.com/kobsio/kobs/pkg/cluster/kubernetes/apis/user/v1"
	scheme "github.com/kobsio/kobs/pkg/cluster/kubernetes/clients/user/clientset/versioned/scheme"
...
func newUsers(c *KobsV1Client, namespace string) *users {
	return &users{
		client: c.RESTClient(),
		ns:     namespace,
	}
