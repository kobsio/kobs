...
import (
	...
	versioned "github.com/kobsio/kobs/pkg/cluster/kubernetes/clients/application/clientset/versioned"
	internalinterfaces "github.com/kobsio/kobs/pkg/cluster/kubernetes/clients/application/informers/externalversions/internalinterfaces"
	v1 "github.com/kobsio/kobs/pkg/cluster/kubernetes/clients/application/listers/application/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KobsV1().Applications(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KobsV1().Applications(namespace).Watch(context.TODO(), options)
			},
		},
