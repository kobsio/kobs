...
var applicationsResource = schema.GroupVersionResource{Group: "kobs.io", Version: "v1", Resource: "applications"}

var applicationsKind = schema.GroupVersionKind{Group: "kobs.io", Version: "v1", Kind: "Application"}
...
func (c *FakeApplications) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(applicationsResource, c.ns, name, opts), &applicationv1.Application{})
