...
import (
	...
	v1 "github.com/kobsio/kobs/pkg/cluster/kubernetes/apis/team/v1"
	scheme "github.com/kobsio/kobs/pkg/cluster/kubernetes/clients/team/clientset/versioned/scheme"
...
func newTeams(c *KobsV1Client, namespace string) *teams {
	return &teams{
		client: c.RESTClient(),
		ns:     namespace,
	}
