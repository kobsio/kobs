...
func TestGetDashboards(t *testing.T) {
	for _, tt := range []struct {
		...
		},
		{
			...
			body:               []byte("{\"references\":[{\"title\":\"Kubernetes Workloads\",\"inline\":{\"rows\":[{\"panels\":[{\"title\":\"Workloads\",\"plugin\":{\"name\":\"resources\",\"options\":[{\"namespaces\":[\"test-service\"],\"resources\":[\"pods\",\"deployments\"],\"selector\":\"app=test-service\"}]}}]}]}},{\"cluster\":\"cluster2\",\"namespace\":\"kobs\",\"name\":\"resource-usage\",\"title\":\"Resource Usage\",\"placeholders\":{\"namespace\":\"test-service\",\"pod\":\"test-service-.*\"}}]}"),
			expectedStatusCode: http.StatusBadRequest,
			expectedBody:       "{\"error\":\"Invalid cluster name\"}\n",
		},
		{
			name:               "get dashboard error",
			body:               []byte("{\"references\":[{\"title\":\"Kubernetes Workloads\",\"inline\":{\"rows\":[{\"panels\":[{\"title\":\"Workloads\",\"plugin\":{\"name\":\"resources\",\"options\":[{\"namespaces\":[\"test-service\"],\"resources\":[\"pods\",\"deployments\"],\"selector\":\"app=test-service\"}]}}]}]}},{\"cluster\":\"cluster1\",\"namespace\":\"kobs\",\"name\":\"resource-usage-wrong\",\"title\":\"Resource Usage\",\"placeholders\":{\"namespace\":\"test-service\",\"pod\":\"test-service-.*\"}}]}"),
			expectedStatusCode: http.StatusBadRequest,
			expectedBody:       "{\"error\":\"Could not get dashboard: could not get dashboard\"}\n",
		},
		{
			name:               "get dashboards",
			body:               []byte("{\"cluster\":\"cluster1\",\"namespace\":\"namespace1\",\"references\":[{\"title\":\"Kubernetes Workloads\",\"inline\":{\"rows\":[{\"panels\":[{\"title\":\"Workloads\",\"plugin\":{\"name\":\"resources\",\"options\":[{\"namespaces\":[\"test-service\"],\"resources\":[\"pods\",\"deployments\"],\"selector\":\"app=test-service\"}]}}]}]}},{\"cluster\":\"cluster1\",\"namespace\":\"kobs\",\"name\":\"resource-usage\",\"title\":\"Resource Usage\",\"placeholders\":{\"namespace\":\"test-service\",\"pod\":\"test-service-.*\"}}]}"),
			expectedStatusCode: http.StatusOK,
			expectedBody:       "[{\"cluster\":\"-\",\"namespace\":\"-\",\"name\":\"-\",\"title\":\"Kubernetes Workloads\",\"variables\":[{\"name\":\"__cluster\",\"label\":\"__cluster\",\"hide\":true,\"plugin\":{\"name\":\"core\",\"options\":{\"type\":\"static\",\"items\":[\"cluster1\"]}}},{\"name\":\"__namespace\",\"label\":\"__namespace\",\"hide\":true,\"plugin\":{\"name\":\"core\",\"options\":{\"type\":\"static\",\"items\":[\"namespace1\"]}}}],\"rows\":[{\"panels\":[{\"title\":\"Workloads\",\"plugin\":{\"name\":\"resources\",\"options\":[{\"namespaces\":[\"test-service\"],\"resources\":[\"pods\",\"deployments\"],\"selector\":\"app=test-service\"}]}}]}]},{\"title\":\"Resource Usage\",\"variables\":[{\"name\":\"__cluster\",\"label\":\"__cluster\",\"hide\":true,\"plugin\":{\"name\":\"core\",\"options\":{\"type\":\"static\",\"items\":[\"cluster1\"]}}},{\"name\":\"__namespace\",\"label\":\"__namespace\",\"hide\":true,\"plugin\":{\"name\":\"core\",\"options\":{\"type\":\"static\",\"items\":[\"namespace1\"]}}},{\"name\":\"namespace\",\"label\":\"namespace\",\"hide\":true,\"plugin\":{\"name\":\"core\",\"options\":{\"type\":\"static\",\"items\":[\"test-service\"]}}},{\"name\":\"pod\",\"label\":\"pod\",\"hide\":true,\"plugin\":{\"name\":\"core\",\"options\":{\"type\":\"static\",\"items\":[\"test-service-.*\"]}}}],\"rows\":null}]\n",
		},
	} {
		t.Run(tt.name, func(t *testing.T) {
			mockClusterClient := &cluster.MockClient{}
