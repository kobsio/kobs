...
func TestGetDashboards(t *testing.T) {
	for _, tt := range []struct {
		...
		},
		{
			...
			body:               []byte("{\"defaults\":{\"cluster\":\"cluster2\",\"namespace\":\"test-service\",\"name\":\"test-service\",\"dashboards\":[{\"title\":\"Kubernetes Workloads\",\"inline\":{\"rows\":[{\"panels\":[{\"title\":\"Workloads\",\"plugin\":{\"name\":\"resources\",\"options\":[{\"namespaces\":[\"test-service\"],\"resources\":[\"pods\",\"deployments\"],\"selector\":\"app=test-service\"}]}}]}]}},{\"namespace\":\"kobs\",\"name\":\"resource-usage\",\"title\":\"Resource Usage\",\"placeholders\":{\"namespace\":\"test-service\",\"pod\":\"test-service-.*\"}}]},\"references\":[{\"title\":\"Kubernetes Workloads\",\"inline\":{\"rows\":[{\"panels\":[{\"title\":\"Workloads\",\"plugin\":{\"name\":\"resources\",\"options\":[{\"namespaces\":[\"test-service\"],\"resources\":[\"pods\",\"deployments\"],\"selector\":\"app=test-service\"}]}}]}]}},{\"namespace\":\"kobs\",\"name\":\"resource-usage\",\"title\":\"Resource Usage\",\"placeholders\":{\"namespace\":\"test-service\",\"pod\":\"test-service-.*\"}}]}"),
			expectedStatusCode: http.StatusBadRequest,
			expectedBody:       "{\"error\":\"Invalid cluster name\"}\n",
		},
		{
			name:               "get dashboard error",
			body:               []byte("{\"defaults\":{\"cluster\":\"cluster1\",\"namespace\":\"test-service\",\"name\":\"test-service\",\"dashboards\":[{\"title\":\"Kubernetes Workloads\",\"inline\":{\"rows\":[{\"panels\":[{\"title\":\"Workloads\",\"plugin\":{\"name\":\"resources\",\"options\":[{\"namespaces\":[\"test-service\"],\"resources\":[\"pods\",\"deployments\"],\"selector\":\"app=test-service\"}]}}]}]}},{\"namespace\":\"kobs\",\"name\":\"resource-usage-wrong\",\"title\":\"Resource Usage\",\"placeholders\":{\"namespace\":\"test-service\",\"pod\":\"test-service-.*\"}}]},\"references\":[{\"title\":\"Kubernetes Workloads\",\"inline\":{\"rows\":[{\"panels\":[{\"title\":\"Workloads\",\"plugin\":{\"name\":\"resources\",\"options\":[{\"namespaces\":[\"test-service\"],\"resources\":[\"pods\",\"deployments\"],\"selector\":\"app=test-service\"}]}}]}]}},{\"namespace\":\"kobs\",\"name\":\"resource-usage-wrong\",\"title\":\"Resource Usage\",\"placeholders\":{\"namespace\":\"test-service\",\"pod\":\"test-service-.*\"}}]}"),
			expectedStatusCode: http.StatusBadRequest,
		...
		},
		{
			...
			body:               []byte("{\"defaults\":{\"cluster\":\"cluster1\",\"namespace\":\"test-service\",\"name\":\"test-service\",\"dashboards\":[{\"title\":\"Kubernetes Workloads\",\"inline\":{\"rows\":[{\"panels\":[{\"title\":\"Workloads\",\"plugin\":{\"name\":\"resources\",\"options\":[{\"namespaces\":[\"test-service\"],\"resources\":[\"pods\",\"deployments\"],\"selector\":\"app=test-service\"}]}}]}]}},{\"namespace\":\"kobs\",\"name\":\"resource-usage\",\"title\":\"Resource Usage\",\"placeholders\":{\"namespace\":\"test-service\",\"pod\":\"test-service-.*\"}}]},\"references\":[{\"title\":\"Kubernetes Workloads\",\"inline\":{\"rows\":[{\"panels\":[{\"title\":\"Workloads\",\"plugin\":{\"name\":\"resources\",\"options\":[{\"namespaces\":[\"test-service\"],\"resources\":[\"pods\",\"deployments\"],\"selector\":\"app=test-service\"}]}}]}]}},{\"namespace\":\"kobs\",\"name\":\"resource-usage\",\"title\":\"Resource Usage\",\"placeholders\":{\"namespace\":\"test-service\",\"pod\":\"test-service-.*\"}}]}"),
			expectedStatusCode: http.StatusOK,
			expectedBody:       "[{\"cluster\":\"-\",\"namespace\":\"-\",\"name\":\"-\",\"title\":\"Kubernetes Workloads\",\"rows\":[{\"panels\":[{\"title\":\"Workloads\",\"plugin\":{\"name\":\"resources\",\"options\":[{\"namespaces\":[\"test-service\"],\"resources\":[\"pods\",\"deployments\"],\"selector\":\"app=test-service\"}]}}]}]},{\"title\":\"Resource Usage\",\"rows\":null}]\n",
		},
	} {
		t.Run(tt.name, func(t *testing.T) {
			mockClusterClient := &cluster.MockClient{}
