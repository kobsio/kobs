...
func TestParseLogsQuery(t *testing.T) {
	for _, tt := range []struct {
		...
		{query: "kubernetes_label_foo = 'bar'", where: "fields_string['kubernetes_label_foo'] = 'bar'", isInvalid: false},
		{query: "kubernetes_label_foo_bar =~ '\\%hellow\\%world\\%'", where: "fields_string['kubernetes_label_foo_bar'] ILIKE '\\%hellow\\%world\\%'", isInvalid: false},
		{query: "kubernetes_label_foo_bar ~ 'hello.*'", where: "match(fields_string['kubernetes_label_foo_bar'], 'hello.*')", isInvalid: false},
		{query: "kubernetes_label_foo_bar / 'hello.*'", isInvalid: true},
	} {
...
func TestHandleConditionParts(t *testing.T) {
	for _, tt := range []struct {
		...
		{key: "helloworld", value: "'foobar'", operator: "=~", expectedCondition: "fields_string['helloworld'] ILIKE 'foobar'"},
		{key: "helloworld", value: "'foobar'", operator: "!~", expectedCondition: "fields_string['helloworld'] NOT ILIKE 'foobar'"},
		{key: "helloworld", value: "'foobar'", operator: "~", expectedCondition: "match(fields_string['helloworld'], 'foobar')"},
		{key: "helloworld", value: "'foobar'", operator: "=", expectedCondition: "fields_string['helloworld'] = 'foobar'"},
		{key: "helloworld", value: "42", operator: "=~", expectedCondition: "fields_number['helloworld'] ILIKE 42"},
		{key: "helloworld", value: "42", operator: "!~", expectedCondition: "fields_number['helloworld'] NOT ILIKE 42"},
		{key: "helloworld", value: "42", operator: "~", expectedCondition: "match(fields_number['helloworld'], 42)"},
		{key: "helloworld", value: "42", operator: "=", expectedCondition: "fields_number['helloworld'] = 42"},
	} {
...
func TestHandleExistsCondition(t *testing.T) {
	for _, tt := range []struct {
		...
		{key: "foobar", expectedCondition: "(mapContains(fields_string, 'foobar') = 1 OR mapContains(fields_number, 'foobar') = 1)"},
	} {
		t.Run(tt.key, func(t *testing.T) {
