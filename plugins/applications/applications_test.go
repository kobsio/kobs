	...
	for _, tt := range []struct {
		...
		},
		{
			...
			prepare: func(mockClusterClient *cluster.MockClient) {
				mockClusterClient.On("GetApplications", mock.Anything, "").Return([]application.ApplicationSpec{
					{Cluster: "cluster1", Namespace: "namespace1", Name: "application1", Topology: application.Topology{Dependencies: []application.Reference{{Cluster: "", Namespace: "", Name: "application2"}}}},
					{Cluster: "cluster1", Namespace: "namespace1", Name: "application2", Topology: application.Topology{Dependencies: []application.Reference{{Cluster: "", Namespace: "namespace2", Name: "application3"}}}},
					{Cluster: "cluster1", Namespace: "namespace2", Name: "application3", Topology: application.Topology{Dependencies: []application.Reference{{Cluster: "cluster2", Namespace: "namespace3", Name: "application4"}, {Cluster: "cluster2", Namespace: "namespace3", Name: "application5"}}}},
		...
		},
		{
			...
			topologyCache: topology.Cache{Topology: &topology.Topology{
				...
				Nodes: []topology.Node{
					{Data: topology.NodeData{ID: "cluster1-namespace1-application1", Type: "application", Label: "application1", Parent: "cluster1-namespace1", ApplicationSpec: application.ApplicationSpec{Cluster: "cluster1", Namespace: "namespace1", Name: "application1", Topology: application.Topology{Dependencies: []application.Reference{{Cluster: "", Namespace: "", Name: "application2"}}}}}},
					{Data: topology.NodeData{ID: "cluster1-namespace1-application2", Type: "application", Label: "application2", Parent: "cluster1-namespace1", ApplicationSpec: application.ApplicationSpec{Cluster: "cluster1", Namespace: "namespace1", Name: "application2", Topology: application.Topology{Dependencies: []application.Reference{{Cluster: "", Namespace: "namespace2", Name: "application3"}}}}}},
					{Data: topology.NodeData{ID: "cluster1-namespace2-application3", Type: "application", Label: "application3", Parent: "cluster1-namespace2", ApplicationSpec: application.ApplicationSpec{Cluster: "cluster1", Namespace: "namespace2", Name: "application3", Topology: application.Topology{Dependencies: []application.Reference{{Cluster: "cluster2", Namespace: "namespace3", Name: "application4"}, {Cluster: "cluster2", Namespace: "namespace3", Name: "application5"}}}}}},
